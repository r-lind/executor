 ...
 */
const LowMemGlobal<VoidUPP> JFLUSH { 0x6F4 }; // idunno guess (true-b);
const LowMemGlobal<VoidUPP> JResUnknown1 { 0x700 }; // idunno resedit (true-b);
const LowMemGlobal<VoidUPP> JResUnknown2 { 0x714 }; // idunno resedit (true-b);
