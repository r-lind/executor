...
extern GDHandle C_GetMaxDevice(const Rect *);
...
extern void C_FillCRect(const Rect *, PixPatHandle);
...
/* QDExtensions trap */
extern QDErr C_NewGWorld(GUEST<GWorldPtr> *, INTEGER, const Rect *, CTabHandle, GDHandle, GWorldFlags);
...
extern GWorldFlags C_UpdateGWorld(GUEST<GWorldPtr> *, INTEGER, const Rect *, CTabHandle, GDHandle, GWorldFlags);
...
extern QDErr C_NewScreenBuffer(const Rect *, Boolean, GUEST<GDHandle> *, GUEST<PixMapHandle> *);
...
extern QDErr C_NewTempScreenBuffer(const Rect *, Boolean, GUEST<GDHandle> *, GUEST<PixMapHandle> *);
